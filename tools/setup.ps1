...
Write-Host ""
Write-Host "주의: 깊이 모델(gan\depth-v2s.xml)은 이 스크립트가 만들지 않는다." -ForegroundColor Yellow
Write-Host "      optimum-intel 이 depth_anything 을 몰라 따로 변환해야 한다 — INSTALL.md 참고." -ForegroundColor DarkGray
