...
(function () {
  ...
  var TOURS = {
    "/": [
      ...
      ["#aiGrid", { ko: "AI 열여섯 가지예요.\n하나를 누르면 카메라가 켜지고\n바로 알아봐요.",
                     en: "Sixteen kinds of AI. Press one —\nthe camera opens and it starts." }],
      ["#appGrid", { ko: "블록·파이썬으로 프로그램을 짜고,\n가르치기에서 내 AI를 만들어요.",
                      en: "Build programs in Blocks and Python,\nand make your own AI in Train." }],
    ...
    "/try": [
      ...
      ["#closeApp", { ko: "다 했으면 [닫기]로 홈에 가서\n다른 것을 골라요.",
                       en: "When you're done, Close takes you\nhome to pick something else." }],
    ],
    "/blocks": [
      [null, { ko: "여기는 블록이에요.\n블록을 끼워 맞춰 AI를 움직여요.",
  ...
  /* 첫 화면에는 모델을 올리는 동안 부팅 덮개(#boot)가 떠 있다. 그게 떠 있을 때
     시작하면 짚을 요소가 아직 없고 로딩 화면까지 가린다. 사라진 뒤에 시작한다.
     덮개가 없는 화면은 바로 시작. */
  function bootGone() {
  ...
  /* #boot 는 lib/boot.js 가 DOMContentLoaded 에 심으므로 아직 없을 수 있다.
     MutationObserver 로 잡으면 대상이 null 이라 터진다 — 그냥 센다.
