...
& $PY -c "from huggingface_hub import snapshot_download; snapshot_download(repo_id='leeyunjai/edge-lab', local_dir='models', ignore_patterns=['models.7z','org/*','yolo/*','*.md'])"
